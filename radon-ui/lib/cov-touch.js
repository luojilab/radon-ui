...
class CovTouch {
    ...
    touchEnd (e) {
        ...
        if (!this.touch.end || !this.touch.start) return
        const distance = this.getDistance(this.touch.end, this.touch.start)
        if (distance < 10) return
        const angle = this.getAngle(this.touch.end, this.touch.start)
