...
export default {
    ...
    data () {
        return {
            code: {
                one: `<rd-progress @click="startProgress(progressCommon)" :progress="progressCommon"></rd-progress>`,
                two: `<rd-progress-circle @click="startProgress(progressCircle)" :progress="progressCircle"></rd-progress-circle>`
            },
            progressCommon1: {
                percent: 10,
                options: {
