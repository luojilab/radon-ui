<style src="radon-ui-css/basic/table.css"></style>
<template>
    <table class="rd-table">
        ...
        <tbody>
            <tr class="rd-table-th" v-for="row in List" track-by="$index">
                ...
                <td class="rd-table-td" v-for="(val, index) in row._value" :key="index">
                    <div v-if="val && typeof val === 'object'">
                        ...
                        <div v-if="val.type === 'clickable' " :class="val.class" @click="val.func">{{val.value}}</div>
                    </div>
                    <div v-else>{{val}}</div>
                </td>
